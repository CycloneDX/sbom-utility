...
[INFO] >> Checking hasProperties: selector: `{"path": "metadata", "primaryKey": {"key": "", "value": ""}}`, properties: '[{timestamp} {supplier} {component} {licenses}]'...
...
[INFO] >> Checking hasProperties: selector: `{"path": "metadata", "primaryKey": {"key": "", "value": ""}}`, properties: '[{authors}]'...
...
[INFO] >> Checking isUnique: selector: `{"path": "metadata.properties", "primaryKey": {"key": "name", "value": "urn:example.com:disclaimer"}}`...
[INFO] >> Checking hasProperties: selector: `{"path": "metadata.properties", "primaryKey": {"key": "name", "value": "urn:example.com:disclaimer"}}`, properties: '[{value This SBOM is current as of the date it was generated and is subject to change.}]'...
