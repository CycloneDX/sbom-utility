...
func VerifySelectedFieldsInJsonMap(t *testing.T, request *common.QueryRequest, results interface{}) (exists bool, err error) {
	...
	keys := strings.Split(request.SelectFieldsRaw, common.QUERY_SELECT_CLAUSE_SEP)
